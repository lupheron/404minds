import { longVideos } from "@/src/lib/site-data";
  ...
  return (
    <div className="mx-auto w-full max-w-7xl px-4 py-12 sm:px-6 lg:py-16">
      <section className="rounded-3xl border border-slate-800 bg-slate-900/40 p-6 sm:p-10">
        <h1 className="text-3xl font-bold text-white sm:text-4xl">Long YouTube Videos (3+ minutes)</h1>
        <p className="mt-4 max-w-3xl text-slate-300">
          These five long-form videos provide detailed context for our class topic: <strong>How AI is changing our
          future</strong>.
        </p>
      </section>
